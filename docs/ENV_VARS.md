...
KF2_BLACKPROBE=1                       # what the picture held every drawn frame around an area load: luminance, black runs, the tint the game asked for, whether the frame's pixels were new, and whether the view was carried
