...
///
///     KF2_TRUECOLOR=0          15-bit; unset is 24-bit (the shipped default)
///
...
/// the only thing that hides them, at the cost of the 4x4 crosshatch. With neither
/// dither nor 24-bit output the bands show raw.
///
...
public static class TrueColor
{
    ...
    public static void Install()
    {
        ...
        // read. ConfigManager only loads inside HostWindow.Initialize, which is
        // after Program.cs, so reading it here would read an empty config and
